...
export const ChatComposer = memo(function ChatComposer({
  ...
  return (
    <div className="mt-2 shrink-0 flex items-center gap-2 rounded-[12px] border border-border bg-[rgba(255,255,255,0.98)] px-3 py-2 shadow-[0_8px_24px_rgba(32,33,35,0.05)]">
      <input
